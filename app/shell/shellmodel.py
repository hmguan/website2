...
def get_online_robot_information(user_id):
    ...
    try:
        ...
        return {'code': errtypes.HttpResponseCode_ServerError,'msg':e,'data':''}
...
def get_offline_robot_information():
    ...
    try:
        ...
        return {'code': errtypes.HttpResponseCode_ServerError,'msg':e,'offline_robot_list':''}
...
def get_robot_system_information(robot_id):
    ...
    try:
        ...
        return {'code': errtypes.HttpResponseCode_ServerError,'msg':e,'system_info':''}
...
def get_robot_process_detail_information(robot_id):
    ...
    try:
        ...
        return {'code': errtypes.HttpResponseCode_ServerError,'msg':e,'process_info_list':''}